...
function FaviconsManifestWebpackPlugin(opts) {
  ...
  _assert2.default.equal(typeof options, 'object', 'FaviconsManifestWebpackPlugin options are required');
  _assert2.default.ok(options.iconSource, 'An input file is required');
...
FaviconsManifestWebpackPlugin.prototype.apply = function apply(compiler) {
  ...
  compiler.plugin('make', (compilation, callback) => {
    (0, _compiler2.default)(self.options, compiler.context, compilation).then(result => {
